            ...
            <button
              ...
              onClick={() =>
                setApiStatus({
                  ...
                  details: 'Please contact your system administrator to reset internal credentials or recover your password.',
                })
              }
              className="text-xs text-brand-700 hover:text-brand-800 dark:text-brand-400 dark:hover:text-brand-300 font-medium focus:outline-none focus:underline cursor-pointer"
            >
              Forgot password?
            </button>
          }
